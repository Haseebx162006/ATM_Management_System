 ...
 * Displays all transactions for the logged-in account.
 */
public class TransactionHistoryController {
    ...
    private void setupTable() {
        ...
        targetColumn.setCellValueFactory(cellData -> {
            Transaction t = cellData.getValue();
            if (t != null) {
                String target = t.getTargetAccountNumber() != null ? t.getTargetAccountNumber() : "-";
                return new javafx.beans.property.SimpleStringProperty(target);
            }
            return new javafx.beans.property.SimpleStringProperty("-");
        });
